...
<div class="table-responsive"><!--  table-responsive Begin  -->
    ...
    <table class="table table-bordered table-hover table-striped"><!--  table table-bordered table-hover Begin  -->
        ...
        <td> NIC #980-231-907 | Mobile No: 0931-7894-9984 | Name: MrGhie</td>
        <td> Real Name: Mr Mughiano | Mobile No: 0931-7894-9984 Country: Pakistan | Name: MrGhie | NIC #980-231-907 </td>
